...
public class ValidOrderController extends BaseController {
	...
	public void handleDownloadInvoice() throws IOException, DocumentException {
		InvoicePDFGenerator.generateInvoicePDF(UserSession.getInstance().getUser(), UserSession.getInstance().getOrder(), UserSession.getInstance().getInvoice(), "C:/Users/marie/eclipse-workspace/projet-java/");
	}
